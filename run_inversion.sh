...
nvfortran gram_joint_inversion.o auxiliar.o parameters.o -cuda -gpu=rdc -cudalib=cublas -lblas -llapack -Mlarge_arrays #-cuda=fastmath #-g -O3 -Mfprelaxed  # -Mcuda=ptxinfo
